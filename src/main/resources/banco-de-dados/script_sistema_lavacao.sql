...
INSERT INTO modelo(descricao, id_marca) VALUES ('Ka', 1);
INSERT INTO modelo(descricao, id_marca) VALUES ('Q5', 3);
INSERT INTO modelo(descricao, id_marca) VALUES ('Toro', 4);

INSERT INTO cliente(nome, celular, email, endereco, data_cadastro, pontuacao) VALUES ('Jose Alfredo', '(48)992345677',
                                                                                       'josealfredo@email.com', 'Rua Jose Alfredo, 356 - Florianopolis', '11/05/2024', 30);
INSERT INTO cliente(nome, celular, email, endereco, data_cadastro, pontuacao) VALUES ('Mariana Silva', '(11)988749090',
                                                                                       'marianasilva@email.com', 'Avenida das Marianas, 4455 - Cidade', '30/10/2022', 40);
INSERT INTO cliente(nome, celular, email, endereco, data_cadastro, pontuacao) VALUES ('Empresa nova', '(51)999234563',
                                                                                       'empresanova@email.com', 'Rua 7, casa 3 - Cidade', '12/01/2024', 20);
INSERT INTO cliente(nome, celular, email, endereco, data_cadastro, pontuacao) VALUES ('Outra empresa', '(47)3233-4556',
                                                                                       'outraempresa@email.com', 'Avenida das empresas, 123 - Jardim empresarial', '23/08/2023', 0);

INSERT INTO pessoa_fisica(id_cliente, cpf, data_nascimento) VALUES (1, '123.456.789-01', '15/02/1987');
INSERT INTO pessoa_fisica(id_cliente, cpf, data_nascimento) VALUES (2, '234.567.890-12', '01/07/1997');

INSERT INTO pessoa_juridica(id_cliente, cnpj, inscricao_estadual) VALUES (3, '12.345.678/0001-00', '388.108.598.269');
INSERT INTO pessoa_juridica(id_cliente, cnpj, inscricao_estadual) VALUES (4, '11.245.648/0001-10', '456.789.123.852');
...
INSERT INTO ordem_servico(total, agenda, id_veiculo) VALUES (165.90, '22/08/2024', 1);
INSERT INTO ordem_servico(total, agenda, id_veiculo) VALUES (89.90, '01/09/2024', 2);
INSERT INTO ordem_servico(total, agenda, id_veiculo) VALUES (68, '30/08/2024', 3);
